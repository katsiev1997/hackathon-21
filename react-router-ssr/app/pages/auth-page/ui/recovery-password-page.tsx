import { Code2, Lightbulb, Lock, Rocket, Users } from "lucide-react";
				...
				<div className="relative z-10 flex flex-col gap-8">
					...
					<div className="space-y-3">
						...
						<p className="max-w-md text-sm leading-relaxed text-white/85">
							Выберите пароль, который вы не используете на других сайтах. После
							сохранения можно сразу войти в HackForge.
						</p>
					</div>
				...
				<div className="relative z-10 mt-10 rounded-xl border border-white/10 bg-slate-950/40 p-4 backdrop-blur-md">
					<div className="flex items-center gap-3">
						<div className="flex -space-x-2">
							{["bg-violet-300", "bg-fuchsia-300", "bg-cyan-300"].map(
								(bg, i) => (
									<span
										key={i}
										className={cn(
